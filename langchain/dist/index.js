...
const generateWithParam = async (topic) => {
...
const processYoutubeVideo = async (url) => {
    try {
        ...
        for (const chunk of chunks) {
            ...
            chunkSummeries.push(res.content);
        }
...
const generateWithImage = async (image_url) => {
    const prompt = new PromptTemplate({
...
const processImage = async (image_url) => {
    ...
    const mess = new HumanMessage(`Analyze the image at this URL: ${image_url}. 
